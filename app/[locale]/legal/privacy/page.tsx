    ...
    return (
        <main className={"max-width"}>
            <section className={clsx("text", "max-width-content")}>
                <h1>{t("title")}</h1>
                {locale !== "de" && (
                    <div className={clsx(styles.hint, "yellow-box-frame")}>
                        <span className={"white-font"}>The privacy policy is only available in german!</span>
                    </div>
                )}
                ...
                <p>
                    ...
                    &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf
                    Informationen im Endger&auml;t des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des TDDDG
                ...
                <p>
                    ...
                    <br />
                    <br />
                    Mehr Info &uuml;ber das Hosting auf Github Pages hier:
                    <br />
                ...
                <p>
                    Quelle:{" "}
                    <a target={"_blank"} href="https://www.e-recht24.de">
